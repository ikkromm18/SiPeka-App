            ...
            <View className='flex flex-col'>
              ...
              <View className='flex flex-row items-center justify-between border-b border-b-gray-600'>
                ...
                <View className='flex flex-row items-center justify-center py-4'>
                  ...
                  <View className="bg-[#fff] rounded-full p-2">
                    <MaterialIcons name="notifications-none" size={35} color="#03BA9B" />
                  </View>

                  <View className='flex flex-col ml-3 max-w-40'>
                    <Text className='font-normal text-white text-normal'>Pindah Antar Kabupaten / Provinsi</Text>
                    <Text className='text-xs font-light text-white'>10 September 2025, 10.00</Text>
                  </View>
